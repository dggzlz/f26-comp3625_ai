...
class CartPoleAgent:
    ...
    That is,
        z = (observation[0] * parameters[0]) + (observation[1] * parameters[1]) + ... + parameters[n]   ← the last parameter is a bias term, 
        like the y-intercept of a linear regression model
        and
